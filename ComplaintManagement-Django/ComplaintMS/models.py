...
class Profile(models.Model):
    ...
    COL = (('Garbage Removal', 'Garbage Removal'), ('Garbage Pickup', 'Garbage Pickup'))  # change college names
    ...
    CB = (('Bhopal', "Bhopal"), ('Kothri', "Kothri"),
          ('Indore', "Indore"),
          ('Aashta', "Aashta"), ('Dewas', "Dewas"))
    Branch = models.CharField(choices=CB, max_length=29, default='Kothri')
...
class Complaint(models.Model):
    ...
    TYPE = (('ClassRoom', "ClassRoom"), ('Teacher', "Teacher"), ('Management', "Management"), ('College', "College"),
            ('Other', "Other"))
